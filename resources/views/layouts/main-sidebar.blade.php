    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="/changePassword">تغير كلمة المرور</a></li>
                </ul> 
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">المرتبات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('bonues.index') }}">العلاوات</a></li>
                    <li><a class="slide-item" href="{{ route('salaries.create') }}">أضافة مرتب</a></li>
                    <li><a class="slide-item" href="{{ route('salaries.index') }}">عرض المرتبات</a></li>
                    <li><a class="slide-item" href="{{ route('payrolls.index') }}">صرف المرتبات</a></li>
                </ul>
            </li>
            @endcan
            @can('عرض التقارير') 
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('reports.create') }}">تقارير </a>
                    </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ route('teachers.index') }}">قائمة الاساتذه</a></li>
                    <li><a class="slide-item" href="{{ route('trainees.index') }}">قائمة المتدربين</a></li>
                    @can('عرض صلاحية') 
            ...
            @endcan
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('طلب اجازة')
                        <li><a class="slide-item" href="{{ route('leaves.create') }}">طلب اجازة</a></li>
                        @endcan
                        @can('طلب استقالة')
                        <li><a class="slide-item" href="{{ route('demissions.create') }}">طلب استقالة</a></li>
                        @endcan
                        @can('اضافة ترقية')
                        <li><a class="slide-item" href="{{ route('bromotions.create') }}">طلب ترقية</a></li>
                        @endcan
                        @can('اضافة تدريب')
                        <li><a class="slide-item" href="{{ route('trainees.create') }}">طلب تدريب</a></li>
                        @endcan
                    </ul>
                </li>
